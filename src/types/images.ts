...
// export type SportsDbTeamResponse = {
...
export enum IMAGE_SECTIONS {
  ...
  MAN_OF_THE_MATCH = 'man_of_the_match',
  CONFRONTO = 'confronto',
  // Novas seções para o GameArtGenerator
...
export const SECTIONS_CONFIG: Record<IMAGE_SECTIONS, SectionConfig> = {
  ...
  // Novas configurações para o GameArtGenerator
  [IMAGE_SECTIONS.INICIO_JOGO]: {
    key: IMAGE_SECTIONS.INICIO_JOGO,
    label: 'Início de Jogo',
    description: 'Imagens para posts do início da partida',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.INTERVALO]: {
    key: IMAGE_SECTIONS.INTERVALO,
    label: 'Intervalo',
    description: 'Imagens para posts do intervalo da partida',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.INICIO_SEGUNDO_TEMPO]: {
    key: IMAGE_SECTIONS.INICIO_SEGUNDO_TEMPO,
    label: 'Início do Segundo Tempo',
    description: 'Imagens para posts do início do segundo tempo',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.INICIO_PRORROGACAO]: {
    key: IMAGE_SECTIONS.INICIO_PRORROGACAO,
    label: 'Início da Prorrogação',
    description: 'Imagens para posts do início da prorrogação',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.INICIO_SEGUNDO_TEMPO_PRORROGACAO]: {
    key: IMAGE_SECTIONS.INICIO_SEGUNDO_TEMPO_PRORROGACAO,
    label: 'Início do Segundo Tempo da Prorrogação',
    description: 'Imagens para posts do início do segundo tempo da prorrogação',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.GOL]: {
    key: IMAGE_SECTIONS.GOL,
    label: 'Gol',
    description: 'Imagens para posts de gols marcados',
    allowedTypes: [IMAGE_TYPES_ENUM.QUADRADA, IMAGE_TYPES_ENUM.VERTICAL]
  },
  [IMAGE_SECTIONS.SUBSTITUICAO]: {
