...
import {
  ...
  PieChart,
  LucideIcon,
} from 'lucide-react'; // 1. Importar o PieChart
import { Button } from '../ui/button';
...
const cardsData: CardData[] = [
  ...
  },
  {
    ...
    title: 'Man of the Match',
    description:
      'Destaque o melhor jogador da partida com design elegante e personalizado.',
    colorClasses: {
      border: 'border border-yellow-100 hover:border-yellow-300',
      iconBg: 'bg-yellow-100',
      iconColor: 'text-yellow-600',
  ...
  },
  {
    ...
    title: 'Dia de Jogo',
    description:
      'Crie posts promocionais para anunciar jogos com data, horário e adversário.',
    colorClasses: {
      border: 'border border-blue-100 hover:border-blue-300',
      iconBg: 'bg-blue-100',
      iconColor: 'text-blue-600',
  ...
  },
  {
    ...
    title: 'Próximo Jogo',
    description:
      'Anuncie o próximo confronto com informações detalhadas e design atrativo.',
    colorClasses: {
      border: 'border border-purple-100 hover:border-purple-300',
      iconBg: 'bg-purple-100',
      iconColor: 'text-purple-600',
